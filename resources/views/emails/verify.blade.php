                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <img align="center" border="0"
                                                                src="{{ asset('images/image-2.jpeg') }}"
                                                                alt="Banner" title="Banner"
                                                                style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 43%;max-width: 249.4px;"
                                                                width="249.4" class="v-src-width v-src-max-width" />
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 180%;"><span
                                                                        style="font-size: 18px; line-height: 32.4px; font-family: Lato, sans-serif;">
                                                                        <strong><span
                                                                                style="line-height: 32.4px; font-size: 18px;">Hi
                                                                                {{ $name }},</span></strong></span>
                                                                    <span
                                                                        style="font-family: Lato, sans-serif; font-size: 16px; line-height: 28.8px;"></span>
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 180%;"> </p>
                                                                <p style="font-size: 14px; line-height: 180%;"><span
                                                                        style="font-size: 16px; line-height: 28.8px; font-family: Lato, sans-serif;">
                                                                        <strong><span
                                                                                style="line-height: 28.8px; font-size: 16px;">
                                                                                To go ahead with your account setup, we
                                                                                would require you to click the verify
                                                                                Now button.</span></strong></span></p>
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 170%;"><span
                                                                        ...
                                                                        will ensure the authenticity of your email
                                                                        information the verification process is pretty
                                                                        simple and short. </span><span
                                                                        style="font-family: Lato, sans-serif; font-size: 16px; line-height: 27.2px;"></span>
                                                                </p>
